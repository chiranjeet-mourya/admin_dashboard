...
const TableSection = () => {
  const getStatusColor = (status) => {
    switch (status) {
      ...
      default:
        return "bg-slate-100 dark:bg-slate-100 text-slate-700 dark:text-slate-400";
    }
  };
        ...
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-b-2xl border border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            {topProducts.map((product, index) => {
              return (
                <div
                  className="flex items-center justify-between p-4 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors"
                  key={index}
                >
