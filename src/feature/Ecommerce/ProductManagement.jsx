    ...
    <>
      ...
      <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-200/50 dark:border-slate-700/50 p-4">
        <div className="flex items-center justify-between">
          <h2 className="text-[18px] text-slate-800 dark:text-white font-semibold">Products</h2>
                ...
                >
                  ...
                  <td className="p-3 flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-md text-slate-700 dark:text-slate-200 font-medium">{product.name}</span>
                      <p className="text-sm text-slate-400 dark:text-slate-200 font-medium">{product.size}</p>
                    </div>
                  </td>
