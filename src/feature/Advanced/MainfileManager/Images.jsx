...
const documentsData = [
  {
    ...
    size: "2.3 MB",
    members: 2,
    icon: <PiImageSquareFill size={18} />,
    members: [
      { id: 1, photo: user },
      { id: 2, photo: user },
    ],
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white dark:bg-slate-900 rounded-lg p-5 w-full max-w-md shadow-lg">
              ...
              <div className="flex flex-col gap-3">
                ...
                <input
                  type="file"
                  accept=".pdf,.doc,.docx,.mp3,.wav,.m4a,.jpg,.jpeg,.png,.gif"
                  onChange={(e) => {
              ...
              {documentsData.map((doc) => (
                ...
                >
                  ...
                  <td className="py-2 px-3 flex items-center gap-2">
                    <div className="w-[30px] h-[30px] bg-red-100 text-red-500 rounded-[6px] flex items-center justify-center">
                      {doc.icon}
                    </div>
                    {doc.name}
                  </td>
